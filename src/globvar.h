...
int   WEQ=0;
int   SEISMO=0, NDT=1, NSRC=1, SEIS_FORMAT=0, SIGOUT_FORMAT=0, FREE_SURF=0, READMOD=0, READREC=0, SRCREC=0, RSG=0, FW=0;
int   NX=1, NY=1, NT=0, SOURCE_TYPE=0, SOURCE_SHAPE=0, SIGOUT=0, SNAP=0, SNAP_FORMAT=0, LOG=0, REC_ARRAY=0;
...
char  SEIS_FILE[STRING_SIZE]="", SIGOUT_FILE[STRING_SIZE]="", LOG_FILE[STRING_SIZE]="";
FILE *FP;
