               ...
               int nfft_min, GlobVar *gv)
{
    ...
    MPI_Allreduce(tmp_CC, CC, 2 * ncplx, MPI_FLOAT, MPI_SUM, MPI_COMM_WORLD);
    MPI_Allreduce(tmp_AC, AC, ncplx, MPI_FLOAT, MPI_SUM, MPI_COMM_WORLD);
    MPI_Allreduce(&tmp_Err_max, &Err_max, 1, MPI_FLOAT, MPI_SUM, MPI_COMM_WORLD);
