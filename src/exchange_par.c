...
/* ****** FWI ****** */
        ...
        idum[84] = vinv->LNORM;
        idum[85] = vinv->DTINV;
        idum[86] = vinv->STEPMAX;
        idum[87] = vinv->TRKILL;
        idum[88] = vinv->TIMEWIN;
        idum[89] = vinv->NORMALIZE;
        idum[90] = vinv->INV_VP_ITER;
        idum[91] = vinv->INV_VS_ITER;
        idum[92] = vinv->MIN_ITER;
        idum[93] = vinv->GRAD_FILTER;
        idum[94] = vinv->FILT_SIZE_GRAD;
        idum[95] = vinv->NO_OF_TESTSHOTS;
        //
...
/* ****** FWI ****** */
    ...
    vinv->LNORM = idum[84];
    vinv->DTINV = idum[85];
    vinv->STEPMAX = idum[86];
    vinv->TRKILL = idum[87];
    vinv->TIMEWIN = idum[88];
    vinv->NORMALIZE = idum[89];
    vinv->INV_VP_ITER = idum[90];
    vinv->INV_VS_ITER = idum[91];
    vinv->MIN_ITER = idum[92];
    vinv->GRAD_FILTER = idum[93];
    vinv->FILT_SIZE_GRAD = idum[94];
    vinv->NO_OF_TESTSHOTS = idum[95];
    //  
