...
int main(int argc, char **argv)
{
    ...
    float **bufferlef_to_rig = NULL, **bufferrig_to_lef = NULL, **buffertop_to_bot = NULL, **bufferbot_to_top = NULL;
    ...
    for (ishot = 1; ishot <= nshots; ishot++) {
        ...
        if (gv.ABS_TYPE == 1) {
            if (gv.L)
                zero_PML_visc(-nd + 1, gv.NX + nd, -nd + 1, gv.NY + nd, pvx, pvy, psxx, psyy, psxy, psi_sxx_x,
                              psi_sxy_x, psi_vxx, psi_vyx, psi_syy_y, psi_sxy_y, psi_vyy, psi_vxy, psi_vxxs, pr, pp, pq,
                              &gv);
            else
                zero_PML_elastic(-nd + 1, gv.NX + nd, -nd + 1, gv.NY + nd, pvx, pvy, psxx, psyy, psxy, psi_sxx_x,
                                 psi_sxy_x, psi_vxx, psi_vyx, psi_syy_y, psi_sxy_y, psi_vyy, psi_vxy, psi_vxxs, &gv);
        }

        if (gv.FDORDER_TIME == 4) {
            if (gv.L) {
                zero_visco_4(-nd + 1, gv.NX + nd, -nd + 1, gv.NY + nd, vxx_1, vxx_2, vxx_3, vxx_4, vyy_1, vyy_2, vyy_3,
                             vyy_4, vxy_1, vxy_2, vxy_3, vxy_4, vyx_1, vyx_2, vyx_3, vyx_4, svx_1, svx_2, svx_3, svx_4,
                             svy_1, svy_2, svy_3, svy_4, pr_2, pr_3, pr_4, pp_2, pp_3, pp_4, pq_2, pq_3, pq_4, &gv);
            } else {
                zero_elastic_4(-nd + 1, gv.NX + nd, -nd + 1, gv.NY + nd, vxx_1, vxx_2, vxx_3, vxx_4, vyy_1, vyy_2,
                               vyy_3, vyy_4, vxy_1, vxy_2, vxy_3, vxy_4, vyx_1, vyx_2, vyx_3, vyx_4, svx_1, svx_2,
                               svx_3, svx_4, svy_1, svy_2, svy_3, svy_4);
            }
        }
        ...
        for (nt = 1; nt <= gv.NT; nt++) {
            ...
            /*---------------------------------------------------------------*/
            if (gv.FDORDER_TIME == 2) {
                update_v_interior(gx, gy, nt, pvx, pvy, psxx, psyy, psxy, prip, prjp,
            ...
            if (gv.FDORDER_TIME == 4) {
                update_v_interior_4(gx, gy, nt, pvx, pvy, psxx, psyy, psxy, prip, prjp,
                                    srcpos_loc, signals, nsrc_loc, hc, svx_1, svx_2, svx_3, svx_4, svy_1, svy_2, svy_3,
                                    svy_4, &gv);
                if (gv.FW) {
                    if (gv.ABS_TYPE == 1) {
                        update_v_PML_4(gv.NX, gv.NY, gx, gy, nt, pvx, pvy, psxx, psyy, psxy, prip, prjp,
                                       K_x, a_x, b_x, K_x_half, a_x_half, b_x_half, K_y, a_y, b_y, K_y_half,
                                       a_y_half, b_y_half, psi_sxx_x, psi_syy_y, psi_sxy_y, psi_sxy_x, svx_1, svx_2,
                                       svx_3, svx_4, svy_1, svy_2, svy_3, svy_4, &gv);
                    }

                    if (gv.ABS_TYPE == 2) {
                        update_v_abs_4(gx, gy, nt, pvx, pvy, psxx, psyy, psxy, prip, prjp, absorb_coeff, svx_1, svx_2,
                                       svx_3, svx_4, svy_1, svy_2, svy_3, svy_4, &gv);
                    }
                }
            ...
            if (gv.FDORDER_TIME == 2) {
		      ...
		      break;
                  case EL_ISO:        /* elastic */
                      ...
                      if (gv.FW) {
                          if (gv.ABS_TYPE == 1)
                              update_s_elastic_PML(gv.NX, gv.NY, gx, gy, nt, pvx, pvy, psxx, psyy, psxy, ppi, pu,
                                                   puipjp, K_x, a_x, b_x, K_x_half, a_x_half, b_x_half, K_y, a_y, b_y,
                      ...
                      if (gv.FW) {
                          if (gv.ABS_TYPE == 1)
                              update_s_visc_PML(gv.NX, gv.NY, gx, gy, nt, pvx, pvy, psxx, psyy, psxy, pr, pp, pq, fipjp,
                                                f, g, bip, bjm, cip, cjm, d, e, dip, K_x, a_x, b_x, K_x_half, a_x_half,
                                                b_x_half, K_y, a_y, b_y, K_y_half, a_y_half, b_y_half, psi_vxx, psi_vyy,
                                                psi_vxy, psi_vyx, &gv);
                          if (gv.ABS_TYPE == 2)
                      ...
                      if (gv.FW) {
                          if (gv.ABS_TYPE == 1)
                              update_s_elastic_VTI_PML(gv.NX, gv.NY, gx, gy, pvx, pvy, psxx, psyy, psxy, pc11, pc13,
                                                       pc33, pc55ipjp, K_x, a_x, b_x, K_x_half, a_x_half, b_x_half, K_y,
                                                       a_y, b_y, K_y_half, a_y_half, b_y_half, psi_vxx, psi_vyy,
                                                       psi_vxy, psi_vyx, &gv);
                          if (gv.ABS_TYPE == 2)
                  ...
                  case EL_TTI:        /* elastic TTI */
                      ...
                      if (gv.FW) {
                          if (gv.ABS_TYPE == 1)
                              update_s_elastic_TTI_PML(gv.NX, gv.NY, gx, gy, pvxx, pvyy,
                                                       pvyx, pvxy, psxx, psyy, psxy,
                  ...
                  case VEL_TTI:       /* viscoelastic TTI */
                      ...
                      if (gv.FW) {
                          if (gv.ABS_TYPE == 1)
                              update_s_visc_TTI_PML(gv.NX, gv.NY, gx, gy, pvxx, pvyy, pvyx, pvxy, psxx, psyy, psxy, pr,
                                                    pp, pq, pc11u, pc33u, pc13u, pc15u, pc35u, pc55ipjpu, pc15ipjpu,
                                                    pc35ipjpu, pc11d, pc33d, pc13d, pc15d, pc35d, pc55ipjpd, pc15ipjpd,
                                                    pc35ipjpd, bip, cip, K_x, a_x, b_x, K_x_half, a_x_half, b_x_half,
                                                    K_y, a_y, b_y, K_y_half, a_y_half, b_y_half, psi_vxx, psi_vyy,
                                                    psi_vxy, psi_vyx, &gv);
                          if (gv.ABS_TYPE == 2)
                              update_s_visc_tti_abs(gx, gy, pvxx, pvyy, pvyx, pvxy, psxx, psyy, psxy, pr, pp, pq,
                                                    pc11u, pc33u, pc13u, pc15u, pc35u, pc55ipjpu, pc15ipjpu, pc35ipjpu,
                                                    pc11d, pc33d, pc13d, pc15d, pc35d, pc55ipjpd, pc15ipjpd, pc35ipjpd,
                                                    bip, cip, absorb_coeff, &gv);
                      }
		   ...
		   default:
            ...
            if (gv.FDORDER_TIME == 4) {
                if (gv.L) {     /* viscoelastic */
                    ...
                    update_s_visc_interior_4(gx, gy, nt, pvx, pvy, psxx, psyy, psxy, pr, pp, pq, fipjp, f, g, bip, bjm,
                                             cip, cjm, d, e, dip, hc, vxx_1, vxx_2, vxx_3, vxx_4, vyy_1, vyy_2, vyy_3,
                                             vyy_4, vxy_1, vxy_2, vxy_3, vxy_4, vyx_1, vyx_2, vyx_3, vyx_4, pr_2, pr_3,
                                             pr_4, pp_2, pp_3, pp_4, pq_2, pq_3, pq_4, &gv);
                    if (gv.FW) {
                        if (gv.ABS_TYPE == 1) {
                            update_s_visc_PML_4(gv.NX, gv.NY, gx, gy, nt, pvx, pvy, psxx, psyy, psxy, pr, pp, pq, fipjp,
                                                f, g, bip, bjm, cip, cjm, d, e, dip, K_x, a_x, b_x, K_x_half, a_x_half,
                                                b_x_half, K_y, a_y, b_y, K_y_half, a_y_half, b_y_half, psi_vxx, psi_vyy,
                                                psi_vxy, psi_vyx, vxx_1, vxx_2, vxx_3, vxx_4, vyy_1, vyy_2, vyy_3,
                                                vyy_4, vxy_1, vxy_2, vxy_3, vxy_4, vyx_1, vyx_2, vyx_3, vyx_4, pr_2,
                                                pr_3, pr_4, pp_2, pp_3, pp_4, pq_2, pq_3, pq_4, &gv);
                        }
                        if (gv.ABS_TYPE != 1) {
                            update_s_visc_abs_4(gx, gy, nt, pvx, pvy, psxx, psyy, psxy, pr,
                                                pp, pq, fipjp, f, g, bip, bjm, cip, cjm, d, e, dip,
                                                absorb_coeff, vxx_1, vxx_2, vxx_3, vxx_4, vyy_1, vyy_2, vyy_3, vyy_4,
                                                vxy_1, vxy_2, vxy_3, vxy_4, vyx_1, vyx_2, vyx_3, vyx_4, pr_2, pr_3,
                                                pr_4, pp_2, pp_3, pp_4, pq_2, pq_3, pq_4, &gv);
                        }
                    }
                    ...
                    update_s_elastic_interior_4(gx, gy, nt, pvx, pvy, psxx, psyy, psxy, ppi, pu, puipjp, hc, vxx_1,
                                                vxx_2, vxx_3, vxx_4, vyy_1, vyy_2, vyy_3, vyy_4, vxy_1, vxy_2, vxy_3,
                                                vxy_4, vyx_1, vyx_2, vyx_3, vyx_4, &gv);

                    if (gv.FW) {
                        if (gv.ABS_TYPE == 1)
                            update_s_elastic_PML_4(gv.NX, gv.NY, gx, gy, nt, pvx, pvy, psxx, psyy, psxy, ppi, pu,
                                                   puipjp, K_x, a_x, b_x, K_x_half, a_x_half, b_x_half, K_y, a_y, b_y,
                                                   K_y_half, a_y_half, b_y_half, psi_vxx, psi_vyy, psi_vxy, psi_vyx,
                                                   vxx_1, vxx_2, vxx_3, vxx_4, vyy_1, vyy_2, vyy_3, vyy_4, vxy_1, vxy_2,
                                                   vxy_3, vxy_4, vyx_1, vyx_2, vyx_3, vyx_4, &gv);
                        if (gv.ABS_TYPE != 1)
                            update_s_elastic_abs_4(gx, gy, nt, pvx, pvy, psxx, psyy, psxy,
                                                   ppi, pu, puipjp, absorb_coeff, vxx_1, vxx_2, vxx_3, vxx_4,
                                                   vyy_1, vyy_2, vyy_3, vyy_4, vxy_1, vxy_2, vxy_3, vxy_4, vyx_1, vyx_2,
                                                   vyx_3, vyx_4, &gv);
                    }
                }
            ...
            /*---------------------------------------------------------------*/
            exchange_s(nd, psxx, psyy, psxy, bufferlef_to_rig, bufferrig_to_lef, buffertop_to_bot, bufferbot_to_top,
                       &gv);
            ...
            if ((gv.SEISMO) && (nt == lsamp) && (nt < gv.NT)) {
                ...
                seismo_ssg(lsamp, ntr, recpos_loc, sectionvx, sectionvy, sectionp, sectioncurl, sectiondiv, pvx, pvy,
                           psxx, psyy, ppi, pu, hc, &gv);
                lsamp += gv.NDT;
            }
        ...
        if (gv.SEISMO) {
            ...
            switch (gv.SEISMO) {
              case 1:          /* particle velocities only */
                  ...
                  if (gv.MPID == 0)
                      saveseis_glob(seismo_fulldata, recpos, ntr_glob, srcpos, ishot, ns, 1, &gv);
                  catseis(sectionvy, seismo_fulldata, recswitch, ntr_glob, ns);
                  if (gv.MPID == 0)
                      saveseis_glob(seismo_fulldata, recpos, ntr_glob, srcpos, ishot, ns, 2, &gv);

                  break;
              case 2:          /* pressure only */
                  catseis(sectionp, seismo_fulldata, recswitch, ntr_glob, ns);
                  if (gv.MPID == 0)
                      saveseis_glob(seismo_fulldata, recpos, ntr_glob, srcpos, ishot, ns, 4, &gv);

                  break;
              case 3:          /* curl and div only */
                  catseis(sectiondiv, seismo_fulldata, recswitch, ntr_glob, ns);
                  if (gv.MPID == 0)
                      saveseis_glob(seismo_fulldata, recpos, ntr_glob, srcpos, ishot, ns, 5, &gv);
                  catseis(sectioncurl, seismo_fulldata, recswitch, ntr_glob, ns);
                  if (gv.MPID == 0)
                      saveseis_glob(seismo_fulldata, recpos, ntr_glob, srcpos, ishot, ns, 6, &gv);
...
//    }
    ...
    if (nsrc_loc > 0) {
        if (signals)
            free_matrix(signals, 1, nsrc_loc, 1, gv.NT);
