...
int main ( int argc, char **argv )
{
    ...
    ** psi_vxx=NULL, ** psi_vyy=NULL, ** psi_vxy=NULL, ** psi_vyx=NULL, ** psi_vxxs=NULL;
    ...
    GlobVar gv = {.OUTNTIMESTEPINFO=100, .NDT=1, .IDX=1, .IDY=1};  
        ...
        if ( gv.SEISMO ) {
            ...
            switch ( gv.SEISMO ) {
                case 1 : /* particle velocities only */
                    ...
                    if ( MYID==0 ) saveseis_glob (seismo_fulldata,recpos,recpos_loc,ntr_glob,srcpos,ishot,ns,1, &gv );
                    catseis ( sectionvy, seismo_fulldata, recswitch, ntr_glob,ns );
                    if ( MYID==0 ) saveseis_glob (seismo_fulldata,recpos,recpos_loc,ntr_glob,srcpos,ishot,ns,2, &gv );
                    
                    break;
                case 2 : /* pressure only */
                    catseis ( sectionp, seismo_fulldata, recswitch, ntr_glob,ns );
                    if ( MYID==0 ) saveseis_glob (seismo_fulldata,recpos,recpos_loc,ntr_glob,srcpos,ishot,ns,4, &gv );
                    
                    break;
                case 3 : /* curl and div only */
                    catseis ( sectiondiv, seismo_fulldata, recswitch, ntr_glob,ns );
                    if ( MYID==0 ) saveseis_glob (seismo_fulldata,recpos,recpos_loc,ntr_glob,srcpos,ishot,ns,5, &gv );
                    catseis ( sectioncurl, seismo_fulldata, recswitch, ntr_glob,ns );
                    if ( MYID==0 ) saveseis_glob (seismo_fulldata,recpos,recpos_loc,ntr_glob,srcpos,ishot,ns,6, &gv );
