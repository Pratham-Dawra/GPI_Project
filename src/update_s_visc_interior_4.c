              ...
              for (int i = gx[2] + 1; i <= gx[3]; i++) {
                  ...
                  *(vxy_1_j + i) = hc[1] * (vx[j + 1][i] - vx[j][i]);
                  ...
                  for (int l = 1; l <= gv->L; l++) {
                      ctemp = 2 * (1 - cip[l]) / c1;
                      r_4[j][i][l] =
                          bip[l] * ((*(r_ji + l)) * cip[l] - ctemp * c2 * ((*(r_ji + l)) + (*(r_2_ji + l))) -
                                    ctemp * c3 * ((*(r_2_ji + l)) + (*(r_3_ji + l))) - ctemp * c4 * ((*(r_3_ji + l)) +
                                                                                                     (*(r_4_ji + l))) -
                                    (dip[j][i][l] * (sumxy + sumyx) * dhi));
                      p_4[j][i][l] =
                          bjm[l] * ((*(p_ji + l)) * cjm[l] - ctemp * c2 * ((*(p_ji + l)) + (*(p_2_ji + l))) -
                                    ctemp * c3 * ((*(p_2_ji + l)) + (*(p_3_ji + l))) - ctemp * c4 * ((*(p_3_ji + l)) +
                                                                                                     (*(p_4_ji + l))) -
                                    (e[j][i][l] * (sumxx + sumyy) * dhi) + (2.0 * d[j][i][l] * sumyy * dhi));
                      q_4[j][i][l] =
                          bjm[l] * ((*(q_ji + l)) * cjm[l] - ctemp * c2 * ((*(q_ji + l)) + (*(q_2_ji + l))) -
                                    ctemp * c3 * ((*(q_2_ji + l)) + (*(q_3_ji + l))) - ctemp * c4 * ((*(q_3_ji + l)) +
                                                                                                     (*(q_4_ji + l))) -
